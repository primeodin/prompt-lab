...
Weekday cadence, in order: chat CLI → RAG → tokenizer → tool agent → **prompt lab (this)** → embedding playground → **vision caption loop (shipped)** → memory → shop-skill explainer.
